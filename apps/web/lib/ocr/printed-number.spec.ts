...
it("accepts only a unique complete printed 2+2+6 number", () => {
  ...
  expect(printedNumber([row("0000 123456")])).toEqual({ series: "0000", number: "123456" });
  expect(printedNumber([row("00 0 0 123456")])).toEqual({ series: "0000", number: "123456" });
  expect(printedNumber([row("0000123456")])).toEqual({ series: "0000", number: "123456" });
